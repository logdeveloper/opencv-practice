...
# 히스토그램을 전체 영역이 아닌 특정 영역의 크기를 적용
# 히스토그램 평활화를 적용하기전 해당 막대를 다른 히스토그램 막대에 균일하게 배분.
...
img_gray = cv.imread("../sample/gypsum.png", cv.IMREAD_GRAYSCALE)
...
result2 = cv.hconcat((img_clahe, img_histo2))
